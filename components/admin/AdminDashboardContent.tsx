...
export default function AdminDashboardContent() {
  ...
  const mainNavItems: { id: MainMenu; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'halaman-utama', label: 'Halaman Web',      icon: <GridIcon /> },
    { id: 'warta',         label: 'Warta',              icon: <NewsIcon /> },
    { id: 'volunteer',     label: 'Volunteer Management', icon: <PeopleIcon /> },
  ];
      ...
      <div className="admin-root" style={{
          ...
          <div className="admin-page-content">
            ...
            {activeMenu === 'home' && (
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '60vh', flexDirection: 'column', gap: 14 }}>
                <div style={{ width: 60, height: 60, background: '#eff3ff', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#3b5bdb' }}>
                  <HomeIcon />
                </div>
                <p style={{ color: '#94a3b8', fontSize: 15, textAlign: 'center', margin: 0 }}>
                  Selamat datang di Dashboard Admin<br />GKI Bungur Bakal Jemaat Alam Sutera
                </p>
              </div>
            )}
            ...
            {activeMenu === 'halaman-utama' && (
              <div>
                <div style={{ marginBottom: 16 }}>
                  <h1 style={{ margin: 0, fontSize: 20, fontWeight: 800, color: '#1e293b' }}>Halaman Web</h1>
        ...
        <div className={`admin-drawer${mobileMenuOpen ? ' open' : ''}`}>
          ...
          <div style={{ padding: '18px 16px 16px', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <img src="/gkias_blue.png" alt="GKI Alam Sutera" style={{ maxHeight: '15px', width: 'auto' }} />
            {/* Close button */}
            <button
              onClick={() => setMobileMenuOpen(false)}
